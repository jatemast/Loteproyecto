        ...
        <aside id="default-sidebar"
            ...
            <div class="flex flex-col h-full px-3 py-4 bg-gradient-to-br from-[#0F293E] to-[#1a3b5c]">
                ...
                <ul id="sidebar-menu" class="flex-grow space-y-2 font-medium">
                    ...
                    <li>
                        <a href="#" onclick="loadContent('presupuestos')"
                            ...
                            <span class="flex-1 transform opacity-0 ms-3 whitespace-nowrap">PRESUPUESTOS </span>
                        </a>
                    </li>
                    <li>
                        <a href="#" onclick="loadContent('roles')"
                            class="flex items-center p-2 text-white rounded-lg hover:bg-[#5989d1] group menu-item">
                            <div class="flex-shrink-0 w-6 h-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-full">
                    ...
                    <li>
                        <a href="#" onclick="loadContent('liquidaciones')"
                            class="flex items-center p-2 text-white rounded-lg hover:bg-[#5989d1] group menu-item">
                            <div class="flex-shrink-0 w-6 h-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-full">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5m-9-6h.008v.008H12v-.008ZM12 15h.008v.008H12V15Zm0 2.25h.008v.008H12v-.008ZM9.75 15h.008v.008H9.75V15Zm0 2.25h.008v.008H9.75v-.008ZM7.5 15h.008v.008H7.5V15Zm0 2.25h.008v.008H7.5v-.008Zm6.75-4.5h.008v.008h-.008v-.008Zm0 2.25h.008v.008h-.008V15Zm0 2.25h.008v.008h-.008v-.008Zm2.25-4.5h.008v.008H16.5v-.008Zm0 2.25h.008v.008H16.5V15Z" />
                            ...
                            <span class="flex-1 transform opacity-0 ms-3 whitespace-nowrap">LIQUIDACIONES</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" onclick="loadContent('reporte')"
                            class="flex items-center p-2 text-white rounded-lg hover:bg-[#bbbaba] group menu-item">
                            <div class="flex-shrink-0 w-6 h-6">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-full h-full">
